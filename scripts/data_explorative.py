...
data_dir = '/home/seb/dev/c#/lotus/analysis/data/'
...
df_score.to_csv(data_dir + 'data_scoresv1.csv')
sns.kdeplot(data=df_score, x="score")
sns.histplot(data=df_score, x="score")